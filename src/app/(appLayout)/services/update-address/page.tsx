    ...
    <div className="container mx-auto px-2 py-4 md:px-4 md:py-8 w-full md:max-w-3xl">
      ...
      >
        ...
        <p className="text-gray-600 text-sm">
          Complete the form below to update your address. All fields marked with * are required.
        </p>
      </motion.div>
        ...
        <div className="p-6 space-y-6">
          {/* Main Form Fields */}
            <div className="space-y-4 mt-4">
              <h2 className="text-lg font-semibold text-gray-800 mb-4">Update Address</h2>
