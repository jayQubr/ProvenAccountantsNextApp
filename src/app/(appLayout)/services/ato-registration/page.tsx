        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              <CustomInput label="Full Name of Applicant/Authorised Person" name="fullName" value={formData.fullName} onChange={handleChange} errors={errors.fullName} placeholder="Enter your full name" />
              ...
              <CustomInput label="Date of Birth of Applicant/Authorised Person" type="date" name="dateOfBirth" value={formData.dateOfBirth} onChange={handleChange} errors={errors.dateOfBirth} placeholder="Enter your date of birth" />
              <div>
