    ...
    <div className="container mx-auto px-2 py-4 md:px-4 md:py-8 w-full md:max-w-3xl">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-gray-800">Period for which BAS Lodgement Copy</h1>
        </div>
        
        <p className="text-gray-600 text-sm">
          Complete the form below to register your BAS lodgement copy. All fields marked with * are required.
        </p>
      </motion.div>
        ...
        <div className="p-6 space-y-6">
          {/* Main Form Fields */}
            <div className="space-y-4 mt-4">
              <h2 className="text-lg font-semibold text-gray-800 mb-4">Period for which BAS Lodgement Copy</h2>
              <CustomInput label="Specify the Quarter" type="text" name="quarter" value={companyData.quarter} onChange={(e) => handleChange(e, 0)} errors={errors.quarter} placeholder="Enter your quarter" />
