      ...
      >
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <CustomCheckbox label="Trustee" name="position" checked={companyData.position === 'Trustee'} onChange={(e) => handleChange(e, 0)} />
            <CustomCheckbox label="Beneficiary" name="position" checked={companyData.position === 'Beneficiary'} onChange={(e) => handleChange(e, 0)} />
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            <p className="text-sm text-gray-600 mb-3">
              All Person who are part of Trust are hereby consented to act for their prescribed positions and authorise to apply for various Tax Registration.
            </p>
